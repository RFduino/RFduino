/*
 ...
 of an RGB LED attached to pins 2 - 4.
 
 The circuit:
 * Common-cathode RGB LED anodes attached to pins 2 - 4
 * LED cathode connected to gnd
 
 * Note: On the RGB LED shield there is already a RGB LED on the board
   connected to pin 2-4, so you don't need any extra components for this example.
 
 To turn on any given channel, set the pin HIGH.  
 To turn off, set the pin LOW. The higher the analogWrite level,

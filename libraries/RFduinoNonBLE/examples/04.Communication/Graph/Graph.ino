/*
 ...
 the value of analog input 5 is sent out the serial port.  We call this "serial"
 ...
 The circuit:
 Any analog input sensor (potentiometer will do) is attached to pin 5.

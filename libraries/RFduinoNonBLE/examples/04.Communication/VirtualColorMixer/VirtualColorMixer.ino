/*
 ...
 The circuit:
 * potentiometers attached to pins 2, 3, and 4
...
const int redPin = 2;		// sensor to control red color
const int greenPin = 3;	        // sensor to control green color
const int bluePin = 4;		// sensor to control blue color
